...
Key Commands
  ...
  [Demo of this sketch in action](http://vimeo.com/110955580), as used by Stephanie Sherriff for her "Whitish Paintings" series.
...
### Mesh Mapping
  ...
  By manipulating a mesh, we begin interleaving physical form and software geometry. Starting with a 3D object, which can be created in a variety of ways. You can use 3D modeling software, like [Sketchup](http://www.sketchup.com/) or [Rhinoceros 3D](http://www.rhino3d.com/), [Maya](http://www.autodesk.com/products/maya/overview), [Cinema4D](http://www.maxon.net/products/cinema-4d-studio/who-should-use-it.html).
  
There are a variety of methods to scan forms, using a depth camera, 2D camera vision, or 3D laser scanners. Even [DIY](http://makezine.com/projects/diy-3d-laser-scanner-using-arduino/) methods.
...
[ProCamToolkit](https://github.com/YCAMInterlab/ProCamToolkit/) is a modular toolkit developed with YCAM Interlab by Kyle Mcdonald, built with OpenFrameworks. It's collection software and code for openFrameworks that uses camera vision to aid in projection mapping tasks.
